...
public static String selectedKey;
 ...
 // Parameterized constructor define the custom key
    public ColumnarCipher(String myKey)
    {
        selectedKey = myKey;
        sortedKeyPos = new int[selectedKey.length()];
        sortedKey = selectedKey.toCharArray();
 ...
 public static void main(String[] args)
    {
 	ColumnarCipher tc = new ColumnarCipher();
        System.out.println("Encrypted Message is: "
                + tc.doEncryption("Columnar Cipher Exapmle"));
        System.out.println("Decrypted Message is: "
                + tc.doDecryption(tc.doEncryption("Columnar Cipher Exapmle")));
    }
}
